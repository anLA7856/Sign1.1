...
public class AddNewStudentSignStateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		if (student_username == null || my_sign_state == null
				|| course_id == null || allow_sign_id == null) {
			return;
		}

		String sign_state = new String(my_sign_state.getBytes("ISO-8859-1"),
				"UTF-8");

		if (student_username == null || sign_state == null || course_id == null
				|| allow_sign_id == null) {
			return;
		}

		// 获得student_id
		String student_id = new StudentDaoImpl()
				.getStudentIdByStudentUsername(student_username);
		// 插入数据
		int result = new SignDaoImpl().addNewSignInfo(sign_state, course_id,
				student_id, allow_sign_id);
